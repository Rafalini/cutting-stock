...
data = pd.read_csv('output/time_summary3.csv')
#FONT SIZES
...
data['Unnamed: 0'] *= 10
ax.plot(data['Unnamed: 0'], data['optimal'], linewidth=2, color='tab:blue', label="Optimal solution")
ax.plot(data['Unnamed: 0'], data['backpack'], linewidth=2, color='tab:orange', label="BinPack solution")
ax.set_yscale('log')
