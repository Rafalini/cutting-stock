...
class AmplSolver(AbstractSolver):
    ...
    def prepareData(self, inputOrder, outputFile, orderType, relaxation):
...
""")
            i = 1
            for order in inputOrder[orderType]:
                if relaxation and order["relaxation_number"] > 0:
    ...
    def prepareDataFiles(self, inputFile, orderType, relaxation):
        ...
        for idx, entry in enumerate(data):
            ...
            self.prepareData(entry, fileName, orderType, relaxation)
